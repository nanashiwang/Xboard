...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        // app
        'windows_version' => 'nullable|string|max:32',
        'windows_min_supported_version' => 'nullable|string|max:32',
        'windows_build_number' => 'nullable|integer|min:0',
        'windows_download_url' => 'nullable|string|max:2048',
        'windows_size_bytes' => 'nullable|integer|min:0',
        'windows_sha256' => 'nullable|regex:/^[a-fA-F0-9]{64}$/',
        'windows_signature' => 'nullable|string',
        'windows_release_notes' => 'nullable|string',
        'windows_published_at' => 'nullable|date',
        'client_registered_device_limit' => 'nullable|integer|min:0',
        'macos_version' => '',
        'macos_download_url' => '',
        'android_version' => '',
